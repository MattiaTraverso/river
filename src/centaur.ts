...
class RuntimeLoader {
  ...
  private static wasmURL: string = `https://unpkg.com/@rive-app/canvas-advanced@2.21.6/rive.wasm`;
...
async function main() {
  ...
  function spawnApples() {
    ...
    while (apples.size < count) {
      ...
      const appleInstance = {
        x: -appleBounds.maxX + Math.random() * appleBounds.maxX,
  ...
  console.log("Character Bounds", bounds);
  ...
  function draw(time) {
    ...
    const characterBounds = character.bounds;
